...
if do_until not in do_until_list:
    sys.exit(
        "E: instead of \"" + sys.argv[2] + "\" you can chouse: trimming, fastqc, sam, second_fastqc, bam, coverage," +
        " vcf, vcf_only, ann, analysis or full")
...
process = subprocess.call(["java", "-jar",
                           ...
                           "SE", "-threads", "8", path + "/" + file1, path + "/trimmed" + file1, "HEADCROP:3"])
if input_file_types == "PE fq":
    process = subprocess.call(["java", "-jar",
                               "/home/bioinf/programs/trimmomatic/Trimmomatic-0.39/trimmomatic-0.39.jar",
                               "SE", "-threads", "8", path + "/" + file2, path + "/trimmed" + file2, "HEADCROP:3"])
...
# for sorting bams
process = subprocess.call(["/home/bioinf/programs/samtools/samtools-1.9/samtools", "sort", "nthreads=8", "-o",
...
# for vcf
vcf = subprocess.call(["/home/bioinf/programs/bcftools/bcftools-1.9/./bcftools", "mpileup",
...
# for snpEff
os.system("java -Xmx8g -jar /home/bioinf/programs/snpEff/snpEff/snpEff.jar -c " +
          "/home/bioinf/programs/snpEff/snpEff/snpEff.config -v hg19 " +
          path + "/" + sample_name + "_no_stars.vcf > " + path + "/filtered_" + sample_name + ".ann.vcf")
