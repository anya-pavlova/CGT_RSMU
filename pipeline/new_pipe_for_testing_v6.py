...
if where_to_start in ["fq", "fastq_sort", "fastqc", "trimming", "sam", "second_fastqc", "bam", "bam_sort", "bam_dup",
    ...
    process = subprocess.call(["python3", "/data/CGT_RSMU/scripts/join_tapes_intervar_all_read_depth.py",
...
if where_to_start in ["fq", "fastq_sort", "fastqc", "trimming", "sam", "second_fastqc", "bam", "bam_sort", "bam_dup",
    ...
    process = subprocess.call(["python3", "/data/CGT_RSMU/scripts/delite_version_in_vcf.py",
                                     sample_name + "_no_stars.vcf"])

    process = subprocess.call(["python3","/data/programs/tapes/tapes/tapes.py",
                                     "annotate", "-i",
                                     path + "/" + 'tapes_' + sample_name + "_no_stars.vcf", "-o",
                                     path + "/" + sample_name + '_tapes' + ".vcf",
                                    '--acmg'])
