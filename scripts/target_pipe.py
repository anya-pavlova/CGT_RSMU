...
do_until = sys.argv[3]
do_until_list = ["trimming","fastqc","sam","second_fastqc","bam","coverage","vcf","ann","full"]
if do_until not in do_until_list:
    sys.exit("E: instead \""+sys.argv[3]+"\" you can chouse: trimming, fastqc, sam, second_fastqc, bam, coverage, vcf, ann or full")
...
"SE", path+"/"+file1, path+"/trimmed"+file1, "HEADCROP:0"])
process=subprocess.call(["java", "-jar",
"/home/bioinf/programs/trimmomatic/Trimmomatic-0.39/trimmomatic-0.39.jar",
"SE", path+"/"+file2, path+"/trimmed"+file2, "HEADCROP:0"])
...
process=subprocess.call(["/home/bioinf/programs/bcftools/bcftools-1.9/./bcftools",
                         ...
                         "-Ov", "-o",
                         path+"/"+sample_name+"no_fucking_stars.vcf",
                         path+"/filtered_"+sample_name+".vcf"])
...
process=subprocess.call(["/home/bioinf/programs/ensembl-vep/vep",
                         "-i", path+"/"+sample_name+"no_fucking_stars.vcf",
...
process=subprocess.call(["python3.5", "/home/bioinf/programs/intervar/InterVar/Intervar.py",
                         "-b", "hg19",
                         "-i", path+"/"+sample_name+"no_fucking_stars.vcf", "--input_type=VCF",
...
#os.remove(path+"/"+sample_name+"no_fucking_stars.vcf")
